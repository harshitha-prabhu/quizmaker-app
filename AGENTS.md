...
- **Cloudflare D1** - SQLite database for data persistence
  - Database Name: `quizmaker-demo-app-database`
  - Database ID: `876ab727-21e2-480a-946f-e02103ebaafe`
...
- **Database Binding**: `quizmaker_demo_app_database` → `quizmaker-demo-app-database`
